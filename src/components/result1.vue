    ...
    <br><br>
      ...
      <div >
        ...
        <table cellspacing="5" style="text-align:center;width:100%;margin-top:10px">
          ...
          <tr class="mytxns" onclick="getAllUsersTxns()">
            <td class="" onclick="getCurrentUserTxns()" id="li_myTxns">
                <p>My Transactions</p>
						</td>
            <td class="active" onclick="getAllUsersTxns()" id="li_allTxns">
      ...
      <div >
			  <div>
				  <div class="tx" id="div_top_hypers">			        
          <ul class="txtab" id="ul_top_hypers">
              <li >
							<ul >
								<li class="" @click="getCurrentUserTxns()" id="li_myTxns">
									<i class="fa fa-bar-chart"></i>My Transactions
								</li>
								<li class="active" @click="getAllUsersTxns()" id="li_allTxns">
									<i class="fa fa-life-ring"></i>All Transactions
								</li>
								<!---->
