  ...
  <section class="game">
    <div class="form">
      <div class="form-group">
        <div >
          <label>Enter Tickets to Buy</label>   
          <div class="input-amount-group">
            ...
            <ul class="amount-rate">
              <li @click="setTickets(.5)">1/2</li> 
              <li @click="setTickets(2)">2X</li> 
              <li @click="setTickets(10)">10X</li> 
            </ul>
          </div>
        </div> 
  ...
  export default {
    ...
    methods: {
      ...
      setTickets(rate) {
        ...
        //const { poolBalance, currentEOS } = this;
        let tickets = this.tickets * rate ;
        let eos = tickets * price ;
        ...
        switch (true) {
          case (tickets < 1): 
            ...
            break;        
          case (tickets > 1000000):
            tickets = 1000000;
            
            break;
        }
        eos = Number(tickets).toFixed(0) * price ;
        this.tickets = Number(tickets).toFixed(0);       
      ...
      /*  let maxAmount = this.maxBetAmount();
        ...
        fetch('//dice.dapp.pub/dice/', {
          ...
          eos.transfer({
            ...
            this.animationTxt = "bet confirmed";
      ...
      checkBetamount() {
        //this.eos = 10 ; 
        //setTickets(1);
        if(this.eos != (this.tickets * this.price))
        {
          this.setTickets(1);
        }
      },
