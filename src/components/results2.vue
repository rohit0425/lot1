<template>
		...
		<div class="game-dice-main">
          ...
          <div data-v-3bf17c98="" data-v-0454fd3a="" data-v-2a183b29="" class="game-comp-lottery">
            ...
            <li data-v-3bf17c98="" class="show-items pool-count">
							<div data-v-3bf17c98="">Current Draw Stats</div>						
							
							</li>
					</ul><ul data-v-3bf17c98="" class="tabs-bar">
						<li data-v-3bf17c98="" class="show-items">
							<div data-v-3bf17c98="">{{yourTickets}}</div>
						...
						<li data-v-3bf17c98="" class="show-items">
							<div data-v-3bf17c98="">{{totalEos}}</div>
							<p data-v-3bf17c98="">Total EOS</p>
						</li>
						<li data-v-3bf17c98="" class="show-items">
							<div data-v-3bf17c98="">{{winCh}}%</div>
              ...
              <li data-v-3bf17c98="" class="ctrl-items">
							<ul data-v-3bf17c98="">
								...
								<li data-v-3bf17c98="" class="" @click="getCurrentUserTxns()" id="li_myTxns">
									<i data-v-3bf17c98="" class="fa fa-bar-chart"></i>My Transactions
								</li>
								<li data-v-3bf17c98="" class="active" @click="getAllUsersTxns()" id="li_allTxns">
									<i data-v-3bf17c98="" class="fa fa-life-ring"></i>All Transactions
								</li>
								<!---->
  ...
  <br><br>
    <div class="game-comp-lottery">
            ...
            <li data-v-3bf17c98="" class="show-items pool-count">
							<div data-v-3bf17c98="">Draw History</div>						
...
export default {
  ...
  methods: {
    ...
    {   
      ...
      document.getElementById('li_myTxns').className = "";   
    ...
    {
      document.getElementById('li_allTxns').className = ""; 
    ...
    getCurrentDrawStat: async function() {
      ...
      for(var i=0; i<this.x;i++)
      {
        ...
        {      
          this.winCh = (Number(this.yourTickets) / Number(this.totalTickets)) * 100;
        }

        this.totalEos = this.yourTickets * this.price;
    ...
    //toggleTable: function (hide)
   // {
   // var lTable = document.getElementById("tab1");
